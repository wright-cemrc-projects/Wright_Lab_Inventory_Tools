...
def launch_app(working_directory='/tmp'):
    ...
    app_context.working_directory = working_directory
    ...
    def on_closing():
        """Fully exit when root window is closed"""
...
if __name__ == "__main__":
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        launch_app(working_directory=tmpdir)